...
RecyclerView.Adapter<RecyclerViewSearchHistoryAdapter.ViewHolder>() {
    inner class ViewHolder(itemView: SearchHistorySearchItemBinding): RecyclerView.ViewHolder(itemView.root) {
        val searchHistoryLabel = itemView.searchHistoryLabel
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = SearchHistorySearchItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)

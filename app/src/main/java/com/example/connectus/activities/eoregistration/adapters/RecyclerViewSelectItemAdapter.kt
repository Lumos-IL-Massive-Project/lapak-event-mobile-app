...
import com.example.connectus.databinding.EoregistrationSelectItemBinding
...
class RecyclerViewSelectItemAdapter(private val provinceList: List<ItemSelectData>) :
    ...
    override fun onCreateViewHolder(
        ...
        return ViewHolder(
            EoregistrationSelectItemBinding.inflate(
    ...
    inner class ViewHolder(itemView: EoregistrationSelectItemBinding) :

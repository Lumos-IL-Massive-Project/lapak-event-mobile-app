...
import com.example.connectus.databinding.ProductdetailTestimonyItemBinding
...
class RecyclerViewTestimonyAdapter(
    ...
    inner class ViewHolder(itemView: ProductdetailTestimonyItemBinding) :
        ...
        fun bind(data: TestimonyData) {
            with(binding) {
                ...
                binding.testimonyItemLayout.setOnClickListener {
    ...
    override fun onCreateViewHolder(
        ...
        return ViewHolder(
            ProductdetailTestimonyItemBinding.inflate(

package com.example.connectus.activities.checkout.adapters

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.connectus.activities.productdetail.models.PlanDetailItemListData
import com.example.connectus.databinding.CheckoutPlanItemBinding
...
class RecyclerViewPlanItemsAdapter(
    ...
    inner class ViewHolder(itemView: CheckoutPlanItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            CheckoutPlanItemBinding.inflate(
